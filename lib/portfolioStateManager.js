...
class PortfolioStateManager {
  ...
  buildAssetsFromTransactions(transactions, prices) {
    ...
    const validTransactions = transactions.filter(tx => !tx.deletedFromHistory);
    console.log(`Filtered out ${transactions.length - validTransactions.length} deleted transactions from history`);
