...
const translations = {
  id: {
    ...
    confirmDeleteTransactionHistory: 'Apakah Anda yakin ingin menghapus riwayat transaksi {type} {asset} ({amount})?',
    deleteTransactionHistoryWarning: '',
    ...
    invalidOrExpiredResetCode: 'Kode reset password tidak valid atau sudah kadaluarsa.',
    ...
    addStockDesc: 'Tambahkan saham Indonesia ke portfolio Anda',
  ...
  en: {
    ...
    confirmDeleteTransactionHistory: 'Are you sure you want to delete transaction history {type} {asset} ({amount})?',
    deleteTransactionHistoryWarning: '',
    ...
    addStockDesc: 'Add Indonesian stocks to your portfolio',
