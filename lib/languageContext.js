...
const translations = {
  id: {
    ...
    broker: 'Broker',
    brokerPlaceholderStock: 'Contoh: Stockbit, Ajaib',
    brokerPlaceholderCrypto: 'Contoh: Binance, Indodax',
    brokerPlaceholderGold: 'Contoh: Pegadaian, Pluang',
    manual: 'MANUAL',
    ...
    purchasePlace: 'Tempat Belinya',
    useManualCurrentPrice: 'Input Harga Saat Ini Manual',
    manualCurrentPrice: 'Harga Saat Ini',
    manualCurrentPriceHint: 'Kosongkan untuk menggunakan harga pasar saat ini',
    ...
    avgPriceHelp: 'Otomatis terkonversi (Realtime)',
    optional: 'Opsional',
    ...
    // Gold
    goldData: 'Data Harga Emas',
    gold: 'Emas',
    goldType: 'Tipe Emas',
    digitalGold: 'Tabungan Emas (Digital)',
    physicalGold: 'Emas Batangan (Fisik)',
    goldBrand: 'Merek (Brand)',
    goldWeight: 'Berat (Gram)',
    goldBuyPrice: 'Harga Beli (per Gram)',
    goldWeightRequired: 'Berat emas (gram) diperlukan',
    goldWeightInvalid: 'Berat emas tidak valid',
    goldPriceInvalid: 'Harga beli tidak valid. Masukkan harga manual jika data tidak tersedia.',
    gram: 'gram',

    // Stock Market
    marketIndonesia: 'Indonesia (IDX)',
    marketUS: 'Amerika (US/Global)',
    tickerSymbol: 'Simbol Ticker',
    tickerSymbolPlaceholder: 'AAPL',
    shareAmount: 'Jumlah Lembar (Shares)',
    enterShareAmount: 'Masukkan jumlah lembar saham yang dibeli',
    lotIs100Shares: '1 lot = 100 lembar',

    // Placeholders
    examplePrice: 'Contoh: {price}',
    exampleBrokerIDX: 'Contoh: Indo Premier, Stockbit, Ajaib',
    exampleBrokerUS: 'Contoh: GoTrade, Pluang, IBKR',
    exampleBrokerCrypto: 'Contoh: Binance, Pintu, Tokocrypto',
    exampleBrokerGoldDigital: 'Contoh: Pegadaian, Pluang',
    exampleBrokerGoldPhysical: 'Contoh: Toko Emas, Brankas Pribadi',
    exampleBankName: 'Contoh: BCA, GoPay, OVO',
    onlyIDRForIDXStocks: '*Hanya tersedia dalam IDR untuk Saham Indonesia',
    ...
    goldDataSource: 'Referensi Harga: Pegadaian (via IndoGold) & Tren Global (XAU/USD)',
    ...
    // Footer
    copyright: '© {year} PortSyncro - Sinkronisasi Portofolio yang Mudah untuk Kripto, Saham, dan Emas',
    ...
    tagline: 'Sinkronisasi Portofolio yang Mudah untuk Kripto, Saham, dan Emas',
    ...
    loginFailedGeneric: 'Gagal masuk. Silakan coba lagi.',
    ...
    strictPasswordRequirements: 'Password harus minimal 8 karakter, mengandung 1 huruf kapital, 1 huruf kecil, 1 angka, dan 1 karakter spesial (@$!%*?&).',
    ...
    viewAssetAllocation: 'Lihat alokasi per aset',
    percentageOfTotal: '% dari Total Porto',
    percentageOfCategory: '% dari Kategori',
    totalCategory: 'Total {category}',

    // Data Sources
    dataSources: 'Sumber Data',
    stockDataSource: 'Yahoo Finance & Google Finance (Real-time Scraping) - Saham IDX & US',
    cryptoDataSource: 'CryptoCompare API (Min-API) - Data harga kripto global',
    exchangeRateSource: 'Frankfurter API & Exchange Rate API - Kurs USD/IDR',
    goldDataSource: 'Pegadaian (via IndoGold) & Yahoo Finance (GLD ETF) untuk tren global',

    // Reset Portfolio
    resetPortfolio: 'Reset Portfolio',
    resetPortfolioDesc: 'Hapus semua aset dan mulai dari awal',
    typeYesToConfirm: 'Ketik "yes" untuk konfirmasi',
    resetWarning: 'Tindakan ini tidak dapat dibatalkan. Semua data portfolio Anda akan dihapus secara permanen.',
    portfolioResetSuccess: 'Portfolio berhasil direset',
    portfolioResetFailed: 'Gagal mereset portfolio',
    ...
    slowConnection: 'Koneksi Internet Lambat',
    connectionRequired: 'Aplikasi ini memerlukan koneksi internet untuk berfungsi.',
    checkConnection: 'Pastikan Anda terhubung ke jaringan WiFi atau data seluler yang stabil.',
    operationsPaused: 'Semua operasi ditangguhkan untuk melindungi data Anda.',
    noChangesLost: 'Tidak ada perubahan yang akan hilang.',
    dataSafe: 'Data Anda aman.',
    autoResumeWhenConnected: 'Operasi akan dilanjutkan secara otomatis saat koneksi membaik.',
    retry: 'Coba Lagi',
    checkAgain: 'Periksa Ulang',
    offline: 'Offline',
    slowConnectionBadge: 'Koneksi Lambat',
    checking: 'Memeriksa...',
    attemptOf: 'Percobaan ke-{current} dari {total}',
    connectionTip: 'Tips: Coba pindah ke lokasi dengan sinyal lebih baik atau gunakan WiFi',
    server: 'Server',
    you: 'Anda',
  },
  en: {
    ...
    // Reset Portfolio
    resetPortfolio: 'Reset Portfolio',
    resetPortfolioDesc: 'Delete all assets and start over',
    typeYesToConfirm: 'Type "yes" to confirm',
    resetWarning: 'This action cannot be undone. All your portfolio data will be permanently deleted.',
    portfolioResetSuccess: 'Portfolio reset successfully',
    portfolioResetFailed: 'Failed to reset portfolio',
    ...
    brokerPlaceholderGold: 'E.g., Pegadaian, Pluang',
    manual: 'MANUAL',
    ...
    useManualCurrentPrice: 'Use Manual Current Price',
    manualCurrentPrice: 'Current Price',
    manualCurrentPriceHint: 'Leave empty to use current market price',
    ...
    avgPriceHelp: 'Automatically converted (Realtime)',
    optional: 'Optional',
    ...
    gold: 'Gold',
    goldType: 'Gold Type',
    digitalGold: 'Digital Gold (Savings)',
    physicalGold: 'Physical Gold (Bar)',
    goldBrand: 'Brand',
    goldWeight: 'Weight (Gram)',
    goldBuyPrice: 'Buy Price (per Gram)',
    goldWeightRequired: 'Gold weight (gram) is required',
    goldWeightInvalid: 'Invalid gold weight',
    goldPriceInvalid: 'Invalid buy price. Enter manual price if data is not available.',
    gram: 'gram',
    ...
    enterShareAmount: 'Enter the number of shares purchased',
    lotIs100Shares: '1 lot = 100 shares',

    // Placeholders
    examplePrice: 'Example: {price}',
    exampleBrokerIDX: 'E.g., Indo Premier, Stockbit, Ajaib',
    exampleBrokerUS: 'E.g., Robinhood, Fidelity, IBKR',
    exampleBrokerCrypto: 'E.g., Binance, Coinbase, Kraken',
    exampleBrokerGoldDigital: 'E.g., Pegadaian, Pluang',
    exampleBrokerGoldPhysical: 'E.g., Gold Store, Private Safe',
    exampleBankName: 'E.g., Chase, PayPal, Venmo',
    onlyIDRForIDXStocks: '*Only available in IDR for Indonesian stocks',
    ...
    // Footer
    copyright: '© {year} PortSyncro - Easy Portfolio Synchronization for Cryptocurrencies, Stocks, and Gold',
    ...
    tagline: 'Easy Portfolio Synchronization for Cryptocurrencies, Stocks, and Gold',
    ...
    strictPasswordRequirements: 'Password must be at least 8 characters, contain 1 uppercase, 1 lowercase, 1 number, and 1 special char (@$!%*?&).',
    ...
    switchToIndonesian: 'Switch to Indonesian',
    switchToEnglish: 'Switch to English',
    calculateAveragePriceDesc: 'Calculate estimated average price',
    assetAllocation: 'Asset Allocation',
    viewAssetAllocation: 'View allocation by asset',
    percentageOfTotal: '% of Total Portfolio',
    percentageOfCategory: '% of Category',
    totalCategory: 'Total {category}',

    // Data Sources
    dataSources: 'Data Sources',
    stockData: 'Stock Data',
    stockDataSource: 'Yahoo Finance & Google Finance (Real-time Scraping) - IDX & US Stocks',
    cryptoData: 'Crypto Data',
    cryptoDataSource: 'CryptoCompare API (Min-API) - Global crypto prices',
    exchangeRateSource: 'Frankfurter API & Exchange Rate API - USD/IDR Rates',
    goldData: 'Gold Data',
    goldDataSource: 'Pegadaian (via IndoGold) & Yahoo Finance (GLD ETF) for global trends',
    ...
    connectionRequired: 'This application requires an internet connection to function.',
    checkConnection: 'Please ensure you are connected to a stable WiFi or mobile data network.',
    operationsPaused: 'All operations are paused to protect your data.',
    noChangesLost: 'No changes will be lost.',
    dataSafe: 'Your data is safe.',
    autoResumeWhenConnected: 'Operations will resume automatically when connection improves.',
    retry: 'Retry',
    checkAgain: 'Check Again',
    offline: 'Offline',
    slowConnectionBadge: 'Slow Connection',
    checking: 'Checking...',
    attemptOf: 'Attempt {current} of {total}',
    connectionTip: 'Tip: Try moving to an area with better signal or use WiFi',
    server: 'Server',
    you: 'You',
  }
};
...
export const LanguageProvider = ({ children }) => {
  ...
  // Prevent flash of wrong content by rendering only after mount (optional, strictly speaking not needed for text but good for consistency)
  // For text, we usually want immediate render, so we don't block.
