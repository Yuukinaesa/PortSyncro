...
const translations = {
  id: {
    ...
    invalidStockFormat: 'Format kode saham tidak valid. Kode saham IDX harus 2-4 huruf (contoh: BBCA, BBRI, UNTR).',
  ...
  en: {
    ...
    invalidStockFormat: 'Invalid stock code format. IDX stock codes should be 2-4 letters (e.g., BBCA, BBRI, UNTR).',
