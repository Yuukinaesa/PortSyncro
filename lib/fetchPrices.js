            ...
            if (res.ok) {
              ...
              if (priceText) {
                ...
                if (!isNaN(parsedPrice) && parsedPrice > 0) {
                  ...
                  // Heuristic: Look for percentage text in the parent container
                  // Handle dot or comma decimals, and unicode minus/plus
                  const pctText = priceElement.parent().parent().text();
                  // Match number followed by % (e.g. "1.25%", "1,25%", "+0.5%")
                  // Also look for unicode minus \u2212
                  ...
                  if (match) {
                    ...
                    // Double check sign logic
                    // If the text contains specific negative indicators but number is positive
