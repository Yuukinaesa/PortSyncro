...
export function exportPortfolioToCSV(assets) {
  let csv = 'Aset,Tipe,Qty,Avg Price,Porto,Gain\n';
  [...assets.stocks, ...assets.crypto].forEach(a => {
    csv += `${a.ticker || a.symbol},${a.type},${a.lots || a.amount},${a.avgPrice},${a.porto},${a.gain}\n`;
  });
  return csv;
} 