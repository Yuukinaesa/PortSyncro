...
// Format: 1.234.567.89 (dots for thousands and decimal)
...
export function exportPortfolioToCSV(assets, language = 'id') {
  ...
  [...assets.stocks, ...assets.crypto].forEach(a => {
    ...
    const avgPrice = formatNumber(a.avgPrice || 0, 2);
    const porto = formatNumber(a.porto || 0, 2);
    const gain = formatNumber(a.gain || 0, 2);
