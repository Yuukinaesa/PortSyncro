...
async function setCommands() {
  ...
  const commands = [
    ...
    { command: 'buy', description: '💰 Beli aset (buy TYPE TICKER QTY PRICE)' },
    { command: 'sell', description: '📤 Jual aset (sell TYPE TICKER QTY PRICE)' },
    ...
    { command: 'prices', description: '💹 Harga portofolio saat ini' },
    { command: 'price', description: '💹 Cek harga ticker spesifik' },
